...
var _user$project$Types$Model = F2(
	function (a, b) {
		return {name: a, rooms: b};
	});
var _user$project$Types$Room = F3(
	function (a, b, c) {
		return {id: a, name: b, users: c};
	});
var _user$project$Types$User = function (a) {
	return {name: a};
};
var _user$project$Types$RoomsResponse = function (a) {
	return {ctor: 'RoomsResponse', _0: a};
};
var _user$project$Types$RequestRooms = {ctor: 'RequestRooms'};
...
var _user$project$Rest$userDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'name',
	_elm_lang$core$Json_Decode$string,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Types$User));
var _user$project$Rest$roomDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'users',
	_elm_lang$core$Json_Decode$list(_user$project$Rest$userDecoder),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'name',
		_elm_lang$core$Json_Decode$string,
		A3(
			...
			'id',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Types$Room))));
var _user$project$Rest$getRooms = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$Types$RoomsResponse,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(
			_elm_lang$http$Http$get,
			'/api/rooms',
			_elm_lang$core$Json_Decode$list(_user$project$Rest$roomDecoder))));
...
var _user$project$State$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			default:
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Rest$getRooms};
		}
	});
var _user$project$State$initialModel = {name: '', rooms: _krisajenkins$remotedata$RemoteData$Loading};
var _user$project$State$init = function (location) {
	return {ctor: '_Tuple2', _0: _user$project$State$initialModel, _1: _user$project$Rest$getRooms};
};

var _user$project$Views_Rooms$roomView = function (room) {
	return A2(
...
var _user$project$Views_Rooms$viewRooms = function (rooms) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$Views_Rooms$roomView, rooms));
};
var _user$project$Views_Rooms$viewRoomsOrError = function (roomsWebData) {
	var _p0 = roomsWebData;
	switch (_p0.ctor) {
		case 'NotAsked':
		...
		default:
			return _user$project$Views_Rooms$viewRooms(_p0._0);
	}
};
var _user$project$Views_Rooms$roomsView = function (rooms) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Views_Rooms$viewRoomsOrError(rooms),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$View$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Views_Rooms$roomsView(model.rooms),
				_1: {ctor: '[]'}
			}
		});
};
